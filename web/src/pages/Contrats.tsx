...
import { coutTotal, estTermine } from '@gmao/partage';
import { dateCourte, joursRestants, toDate } from '@gmao/partage';
import { montant, nombre, normaliser, pourcent } from '@gmao/partage';
import { TYPE_CONTRAT, TYPE_TIERS } from '@gmao/partage';
import type { Contrat, Fournisseur } from '@gmao/partage';
