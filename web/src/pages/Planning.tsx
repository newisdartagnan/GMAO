...
import { estOuvert, tempsPasseMin } from '@gmao/partage';
import { addDays, aujourdHui, dateCourte, iso } from '@gmao/partage';
import { duree, nombre, pourcent } from '@gmao/partage';
import type { OrdreTravail } from '@gmao/partage';
