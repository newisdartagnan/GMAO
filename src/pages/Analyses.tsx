...
import { heures, montant, nombre, pourcent, tronquer } from '@/lib/format';
import { CAUSE_PANNE, DOMAINE } from '@/types/labels';
import { telecharger, versCSV } from '@/data/persistance';
import type { CausePanne, Equipement } from '@/types/domain';
